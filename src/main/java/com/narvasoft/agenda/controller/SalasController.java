...
public class SalasController {
    ...
    @GetMapping("/nuevo")//<--api para crear un nuevo registro
    public String nuevo(Model model) {//<--se crea un objeto modelo de tipo sala
        model.addAttribute("sala", new Salas());//<--se agrega el objeto diario al modelo");
        return "nuevoSala";//<--se redirecciona a la vista nuevoDiario.html
    }

    @PostMapping("/nuevo")//<--api para guardar un nuevo registro
    ...
    public String editar(@PathVariable Long id, Model model) {
        ...
        return "nuevoSala";//al momento de editar se redirecciona a la vista nuevo.html
    }
    ...
    public String editar(
        ...
        salaFromBD.setPc1(sala.isPc2());
        salaFromBD.setPc1(sala.isPc3());
        salaFromBD.setPc1(sala.isPc4());
        salaFromBD.setPc1(sala.isPc5());
        salaFromBD.setPc1(sala.isPc6());
        salaFromBD.setPc1(sala.isPc7());
        salaFromBD.setPc1(sala.isPc8());
        salaFromBD.setPc1(sala.isPc9());
        salaFromBD.setPc1(sala.isPc10());
